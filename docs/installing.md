...
编码方案默认为“国际摩斯优先”，包含 A–Z、0–9 和 18 个常用标点；其中未获国际定义的标点采用常见扩展。反引号（\`）另用七个点 `•••••••`，位于数字行最左侧。升级后请留意标点及 F9、Delete、Tab、星号、百分号、修饰键锁定的编码变化；需要原有编码时，在设置中选择“旧版专用”，保存后重新开始输入。详细差异见 [完整码表](../codechart.md)。
